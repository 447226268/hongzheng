...
<template>
  <div id="layout">
    ...
    >
      <el-image
        class="logo"
        v-if="$store.getters.flag === 'false' ? true : false"
        :src="url"
        fit="fit"
      ></el-image>
      ...
      <el-submenu index="2">
        ...
        <el-menu-item-groupd>
          <el-menu-item index="2-1" route="/studentinfo"
            >学员基本信息</el-menu-item
          >
          <el-menu-item index="2-2" route="/orderinfo">订单信息</el-menu-item>
        </el-menu-item-groupd>
      </el-submenu>
      ...
      <el-submenu index="3">
        ...
        <el-menu-item-groupd>
          <el-menu-item index="3-1" route="/studentinsert"
            >学员信息添加</el-menu-item
          >
      ...
      <el-menu-item index="5" route="/manage" v-if="isadmin">
