<template>
  <div class="manage">
    <div class="table">
      <hztable
        v-bind:value="tableData"
        ref="hztable"
        v-on:enter="enterManage"
        v-on:edit="editManage"
        v-on:remove="removeManage"
        v-on:freezes="freezesManage"
      ></hztable>
      <el-pagination
        class="pagination"
        background
...
<script>
import { number, getrange, remove, updatestate } from "@/api/order.js";
