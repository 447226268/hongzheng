<template>
  <div class="manage">
    <div class="table">
      <hztable v-bind:value="tableData" ref="hztable" v-on:enter="enterManage" v-on:edit="editManage"
        v-on:remove="removeManage" v-on:freezes="freezesManage"></hztable>
      <el-pagination class="pagination" background layout="total, sizes, prev, pager, next, jumper"
        :page-sizes="[10, 20, 50, 100]" @size-change="sizeChange" :total="total" :current-page="current"
